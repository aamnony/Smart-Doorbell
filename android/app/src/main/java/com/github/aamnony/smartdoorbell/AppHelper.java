...
public class AppHelper {
     ...
     * [[Cognito -> User Pools -> <your-users-pool> -> Pool ID]]
     */
    static final String USER_POOL_ID = null;
    /**
     * Cognito identities pool ID. For this app, pool needs to be unauthenticated pool with AWS IoT permissions.
     * [[Cognito -> Identities Pools -> <your-identities-pool> -> Edit identity pool -> Pool ID]]
     */
    static final String IDENTITIES_POOL_ID = null;
    /**
     * App client ID.
     * [[Cognito -> User Pools -> <your-users-pool> -> App clients]]
     */
    ...
    /**
     * Region of AWS Cognito.
     */
    static final Regions COGNITO_REGION = null;
    /**
     * AWS IoT Endpoint.
     * [[IoT Core -> Settings]]
     */
    static final String CUSTOMER_SPECIFIC_ENDPOINT = null;
    /**
     * Name of the AWS IoT policy to attach to a newly created certificate.
     * [[IoT Core -> Secure -> Policies -> <your-policy>]]
     */
    static final String AWS_IOT_POLICY_NAME = "PubSubPolicy";
    /**
     * Region of AWS IoT.
     */
    static final Regions IOT_REGION = COGNITO_REGION;
    /**
     * Filename of KeyStore file on the filesystem.
     */
    static final String KEYSTORE_NAME = "iot_keystore";
    /**
     ...
     */
    static final String CERTIFICATE_ID = "default";
    ...
    public static void init(Context context) {
        ...
        if (userPool == null) {
            ...
            cipClient.setRegion(Region.getRegion(COGNITO_REGION));
